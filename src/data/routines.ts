...
export const routines: Routine[] = [
  ...
  },
  {
    ...
    blocks: buildRounds([
      ...
      { type: "exercise", exercise: { id: "kb-row", name: "KB Bent-over Row", kind: "row", reps: 10, cue: "Hinge forward with a flat back and pull the kettlebell to your hip. Squeeze your shoulder blade at the top.", equipment: "Kettlebell", image: kbRowImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "halo", name: "KB Halo", kind: "halo", reps: 10, cue: "Circle the kettlebell around your head 10 times in each direction. Keep your core braced and shoulders relaxed.", equipment: "Kettlebell", image: haloImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "pushup", name: "Push-ups", kind: "pushup", reps: 10, cue: "Lower your body with control, then push back up. Keep your core tight and your body in a straight line.", equipment: "Mat", image: pushupImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "plank", name: "Plank", kind: "plank", duration: 40, cue: "Hold your body in a straight line from head to heels. Keep your core tight and avoid letting your hips drop.", equipment: "Mat", image: plankImg } },
  ...
  },
  {
    ...
    accent: "cyan",
    blocks: buildRounds([
      { type: "exercise", exercise: { id: "db-squat", name: "Dumbbell Squat", kind: "squat", reps: 12, cue: "Stand with feet shoulder-width apart holding dumbbells. Lower your hips into a squat, then stand back up. Keep your chest upright.", equipment: "Dumbbell", image: dbSquatImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "db-shoulder-press", name: "Dumbbell Shoulder Press", kind: "generic", reps: 10, cue: "Hold dumbbells at shoulder height. Press them overhead until arms are extended, then lower with control.", equipment: "Dumbbell", image: dbShoulderPressImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "db-bent-row", name: "Dumbbell Bent Over Row", kind: "row", reps: 12, cue: "Hinge at the hips with a flat back. Pull the dumbbells toward your torso, then lower slowly.", equipment: "Dumbbell", image: dbBentRowImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "db-lunges", name: "Dumbbell Lunges", kind: "lunge", reps: 10, cue: "Step forward into a lunge while holding dumbbells. Lower your back knee toward the floor, then push back up. 10 reps each leg.", equipment: "Dumbbell", image: dbLungesImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "db-russian-twist", name: "Dumbbell Russian Twist", kind: "twist", reps: 20, cue: "Sit with feet slightly off the ground. Hold a dumbbell and rotate side to side, keeping your core engaged.", equipment: "Dumbbell", image: dbRussianTwistImg } },
    ]),
  },
  {
    id: "pp-starter",
    ...
    accent: "rose",
    blocks: buildRounds([
      { type: "exercise", exercise: { id: "pp-deep-breathing", name: "Deep Breathing", kind: "generic", duration: 45, cue: "Lie on your back with bent knees. Breathe slowly into your belly and gently activate your core on the exhale.", equipment: "—", image: ppDeepBreathingImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "pp-glute-bridge", name: "Glute Bridge", kind: "generic", reps: 10, cue: "Lie on your back with bent knees. Press through your feet and lift your hips, then lower slowly.", equipment: "—", image: ppGluteBridgeImg } },
      restShort(20),
      { type: "exercise", exercise: { id: "pp-bird-dog", name: "Bird Dog", kind: "generic", reps: 10, cue: "Start on hands and knees. Extend opposite arm and leg while keeping your hips stable.", equipment: "—", image: ppBirdDogImg } },
      restShort(20),
